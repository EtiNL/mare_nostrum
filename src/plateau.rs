    ...
    impl TerritoireEnum {
        ...
        pub fn create(&self) -> Territoire {
            match self {
                ...
                TerritoireEnum::Numidia => Territoire::new("Numidia", Terrain::Terre, None, vec![(BatimentsTypes::Caravane(RessourceType::Mouton), false),
                ...
                TerritoireEnum::MareGyprium => Territoire::new("Mare Gyprium", Terrain::Mer, None),
